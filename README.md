...
> **⚠️ Disclaimer**: This tool is strictly for **educational and authorized testing purposes only**. Misuse against unauthorized targets may be illegal.
...
- **Rotating User-Agents** from a built-in list of 200+ real browsers & bots
...
1.Clone or download the script and save it as load_test.py

2.Install dependencies:

3.Bashpip install requests
...
```
Only use this tool on websites you own or have explicit written permission to test.
Excessive use may result in IP bans or legal action.
The author takes no responsibility for any damage or consequences from misuse.
```
